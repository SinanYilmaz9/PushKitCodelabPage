...
<p>You can download the codelab project from: <a href="https://github.com/huaweicodelabs/PushKit/tree/master/TopicPushCodelab" target="_blank">https://github.com/huaweicodelabs/PushKit/tree/master/TopicPushCodelab</a></p>

<h2><strong>Creating a Project</strong></h2>
<p><strong>Step 1</strong>: Start Android Studio.</p>
<p><strong>Step 2</strong>: Choose <strong>File</strong> &gt; <strong>Open</strong>, go to the directory where the sample project is decompressed, and click <strong>OK</strong>.<br><img style="width: 230.00px" src="https://raw.githubusercontent.com/SinanYilmaz9/pushkitcodelabpage/main/assets/pushkitcodelab.jpg" onclick="imageclick(src)"></p>
...
<ul>
    ...
    </span><span class="str">            //Push Kit</span><span class="pln">
		implementation </span><span class="str">'com.huawei.hms:push:5.0.2.300'</span><span class="pln">
		</span><span class="pun">...</span><span class="pln">
	</span><span class="pun">}</span><span class="pln">
	</span></code></pre>
  <p>For Push Kit, please refer to <a href="https://developer.huawei.com/consumer/en/doc/development/HMSCore-Guides/version-change-history-0000001050040072" target="_blank">latest version</a>.</p>
	</li>
